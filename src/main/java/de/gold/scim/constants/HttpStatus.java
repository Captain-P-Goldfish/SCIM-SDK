 ...
 * Foundation (ASF) under one or more contributor license agreements. See the NOTICE file distributed with
 * this work for additional information regarding copyright ownership. The ASF licenses this file to you under
 * the Apache License, Version 2.0 (the "License"); you may not use this file except in compliance with the
 ...
 * <br>
 * copied this class from apache.httpcore Constants enumerating the HTTP status codes. All status codes
 * defined in RFC1945 (HTTP/1.0), RFC2616 (HTTP/1.1), and RFC2518 (WebDAV) are listed.
 *
 * @since 4.0
 */
