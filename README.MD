...
- [x] Cursor based pagination [RFC9865](https://datatracker.ietf.org/doc/html/rfc9865) ([@see Cursor based pagination](https://github.com/Captain-P-Goldfish/SCIM-SDK/wiki/Cursor-bases-pagination-(RFC9865)))
