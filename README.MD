...
| Branch | Current Release                                                                 | CI Build Status                                                                                                                                                              | Code Coverage                                                                                                                                                     | License                                                                       |
|:-------|:--------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------| 
| master | ![Release](https://img.shields.io/github/v/release/Captain-P-Goldfish/SCIM-SDK) | [![Build](https://github.com/Captain-P-Goldfish/SCIM-SDK/actions/workflows/maven.yml/badge.svg)](https://github.com/Captain-P-Goldfish/SCIM-SDK/actions/workflows/maven.yml) | [![codecov](https://codecov.io/gh/Captain-P-Goldfish/SCIM-SDK/branch/master/graph/badge.svg?token=z8URG24FO3)](https://codecov.io/gh/Captain-P-Goldfish/SCIM-SDK) | ![License](https://img.shields.io/github/license/Captain-P-Goldfish/SCIM-SDK) |
...
for usage with Jackson 3

```xml
<dependency>
    <groupId>de.captaingoldfish</groupId>
    <artifactId>scim-sdk-server</artifactId>
    <version>${project.version}-jackson3</version>
</dependency>
<dependency>
    <groupId>de.captaingoldfish</groupId>
    <artifactId>scim-sdk-client</artifactId>
...
- [x] Cursor based pagination [RFC9865](https://datatracker.ietf.org/doc/html/rfc9865) ([@see Cursor based pagination](https://github.com/Captain-P-Goldfish/SCIM-SDK/wiki/Cursor-based-pagination-(RFC9865)))
