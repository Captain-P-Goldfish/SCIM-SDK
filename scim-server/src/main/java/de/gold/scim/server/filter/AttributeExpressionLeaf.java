...
import de.gold.scim.server.filter.antlr.CompareValue;
...
public final class AttributeExpressionLeaf extends FilterNode
{
   ...
   * {@link de.gold.scim.server.filter.antlr.ScimFilterParser.ValuePathContext} and returns the parent attribute
   * path context if present
   */
   ...
   * {@link de.gold.scim.server.filter.antlr.ScimFilterParser.CompareOperatorContext} node
   *
