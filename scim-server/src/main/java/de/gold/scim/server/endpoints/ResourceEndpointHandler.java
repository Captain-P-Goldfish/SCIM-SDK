...
import de.gold.scim.server.endpoints.base.SchemaEndpointDefinition;
...
import de.gold.scim.server.exceptions.IOException;
...
import de.gold.scim.server.filter.resources.FilterResourceResolver;
import de.gold.scim.server.patch.PatchHandler;
import de.gold.scim.server.request.PatchOpRequest;
import de.gold.scim.server.request.SearchRequest;
...
import de.gold.scim.server.response.CreateResponse;
import de.gold.scim.server.response.DeleteResponse;
import de.gold.scim.server.response.ErrorResponse;
import de.gold.scim.server.response.GetResponse;
import de.gold.scim.server.response.ListResponse;
import de.gold.scim.server.response.PartialListResponse;
import de.gold.scim.server.response.ScimResponse;
import de.gold.scim.server.response.UpdateResponse;
