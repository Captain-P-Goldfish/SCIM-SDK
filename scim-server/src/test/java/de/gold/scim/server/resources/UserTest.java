...
import de.gold.scim.server.resources.complex.Address;
import de.gold.scim.server.resources.complex.Manager;
import de.gold.scim.server.resources.complex.Name;
import de.gold.scim.server.resources.multicomplex.Email;
import de.gold.scim.server.resources.multicomplex.Entitlement;
import de.gold.scim.server.resources.multicomplex.GroupNode;
import de.gold.scim.server.resources.multicomplex.Ims;
import de.gold.scim.server.resources.multicomplex.MultiComplexNode;
import de.gold.scim.server.resources.multicomplex.PersonRole;
import de.gold.scim.server.resources.multicomplex.PhoneNumber;
import de.gold.scim.server.resources.multicomplex.Photo;
import de.gold.scim.server.resources.multicomplex.ScimX509Certificate;
