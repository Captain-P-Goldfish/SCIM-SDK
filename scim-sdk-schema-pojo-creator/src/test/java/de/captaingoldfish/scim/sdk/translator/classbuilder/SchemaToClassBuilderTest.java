...
public class SchemaToClassBuilderTest
{
  ...
  public void testSchemaToClassBuilderTest()
  {
    ...
    Assertions.assertEquals("package ???\n" + "\n" + "import java.util.List;\n" + "import java.util.Optional;\n"
                            ...
                            + "  public User() { }\n"
                            + "public User(String id, String externalId, String userName, Name name, String displayName, String nickName, String profileUrl, String title, String userType, String preferredLanguage, String locale, String timezone, Boolean active, String password, List<Emails> emailsList, List<PhoneNumbers> phoneNumbersList, List<Ims> imsList, List<Photos> photosList, List<Addresses> addressesList, List<Groups> groupsList, List<Entitlements> entitlementsList, List<Roles> rolesList, List<X509Certificates> x509CertificatesList, Meta meta) \n"
                            ...
                            + "public static final String SCHEMA_ID = \"urn:ietf:params:scim:schemas:core:2.0:User\";\n"
