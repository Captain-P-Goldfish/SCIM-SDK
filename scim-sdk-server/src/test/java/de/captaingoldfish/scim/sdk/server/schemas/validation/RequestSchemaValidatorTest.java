...
public class RequestSchemaValidatorTest implements FileReferences
{
  ...
  public void testValidateUserDocumentWithWritableFieldsOnly()
  {
    ...
    final JsonNode userResource = User.builder()
                                      ...
                                      .addresses(Arrays.asList(Address.builder()
                                                                      ...
                                                                      .build()))
                                      .build();
    RequestSchemaValidator requestSchemaValidator = new RequestSchemaValidator(userResourceType);
    User user = (User)Assertions.assertDoesNotThrow(() -> {
      return requestSchemaValidator.validateDocument(userResource, HttpMethod.POST);
    });
  ...
  public void testRequiredExtensionIsMissing()
  {
    ...
    try
    {
      requestSchemaValidator.validateDocument(userResource, HttpMethod.POST);
