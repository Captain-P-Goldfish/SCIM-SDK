...
public class MetaTest
{
  ...
  /**
   * verifies that the create builder methods of {@link Meta.MetaBuilder} are correctly used
   */
  @Test
  ...
  /**
   * verifies that the lastModified builder methods of {@link Meta.MetaBuilder} are correctly used
   */
  @Test
