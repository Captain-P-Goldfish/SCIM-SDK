package de.captaingoldfish.scim.sdk.client.tests.scim;
...
public class UserHandler extends ResourceHandler<User>
{
  ...
  public UserHandler()
  {
    try (InputStream inputStream = getClass().getResourceAsStream(TestConstants.BASE_PATH + "/data/firstnames.txt");
