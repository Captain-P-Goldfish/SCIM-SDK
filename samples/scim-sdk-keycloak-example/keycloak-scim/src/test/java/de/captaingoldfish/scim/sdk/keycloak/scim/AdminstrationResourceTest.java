...
public class AdminstrationResourceTest extends KeycloakScimManagementTest
{
   ...
   */
  private AdminstrationResource adminstrationResource;
  ...
  {
    adminstrationResource = new AdminstrationResource(getKeycloakSession(), getAuthentication());
  }
  ...
  public void testUpdateServiceProviderConfiguration()
  {
    ...
    Response response = adminstrationResource.updateServiceProviderConfig(serviceProvider.toString());
